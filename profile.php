			...
			<ul class="nav navbar-nav navbar-right">
					...
					<div class="dropdown-menu" style="width:400px;">
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									<div class="col-md-3 col-xs-3">Opción</div>
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span><?php echo "Hi,".$_SESSION["name"]; ?></a>
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="modificar.php?id=<?php echo $_POST['user_id']; ?>" style="text-decoration:none; color:blue;">Modificar Datos Personales</a></li>
						<li class="divider"></li>
						<li><a href="" style="text-decoration:none; color:blue;">Modificar Productos</a></li>
						<li class="divider"></li>
						<li><a href="" style="text-decoration:none; color:blue;">Ordenes Ingresadas</a></li>
						<li class="divider"></li>
						<li><a href="" style="text-decoration:none; color:blue;">Ingresar nuevo Producto</a></li>
						<li class="divider"></li>
