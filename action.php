	...
	if(isset($_POST["addToProduct"])){
		...
		if($count > 0){
			...
			echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Lo siento ..! debe registrarse, para agregar un producto al carrito</b>
					</div>
				";
		}
	...
	if($run_query){
		echo "
			<div class='alert alert-danger'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<b>El producto se ha eliminado del carrito con exito..!</b>
			</div>
		";
	}
}
...
if(isset($_POST["updateProduct"])){
	...
	if($run_query){
		echo "
			<div class='alert alert-success'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<b>El producto se ha actualizado con exito..!</b>
			</div>
		";
	}
}
